...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li><Link className='font-semibold flex sm:hidden text-gray-800' to='/register'>Register</Link></li>
    </>;

    return (
        <div className="navbar bg-slate-200 py-5 px-5">
            ...
            <div className="sm:ml-auto hidden mr-5 sm:flex">
                <Link className='font-semibold text-gray-800' to='/register'>Register</Link>
            </div>
        </div>
    );
};
